...
function tucao_create_row(i, d)
{
    ...
    c.click(function ()
    {
        ...
        var q = r.parents(".jandan-tucao").f
            ind("textarea.tucao-content");
        var p = q.val();
        if (p.indexOf(o) == -1)
        {
            q.val(q.val() + " " + o + " ")
...
function tucao_show_more_btn(b, c)
{
    ...
    if (a.length == 0)
    {
        a = $('<div class="jandan-tucao-more"><a href="/t/' + c + '#more" target="_blank">? 更多吐槽</a></div>');
        b.append(a)
    }
}
function tucao_load_content(e, d, c)
{
    var a = $('<div class="jandan-tucao" id="jandan-tucao-' + d + '">数据加载中....biubiubiu....</div>');
    e.append(a);
    var b = "/tucao/" + d;
    if (c)
    {
...
var jdnb9Jx15vpWVTnv0cakVQ6X1Ccn5twi6U = function (o, y, g)
{
    var d = o;
    var l = "DECODE";
    var y = y ? y : "";
...
(function ()
{
    ...
    b.btoa || (b.btoa = function (g)
    {
        ...
        for (var i, e, d = 0, h = c, f = ""; j.charAt(d | 0) || (h = "=", d % 1); f += h.charAt(63 & i >> 8 - d % 1 * 8))
        {
            ...
            if (e > 255)
            {
                throw new a("'btoa' failed: The string to be encoded contai
                    ns characters outside of the Latin1 range.")
            }
            i = i << 8 | e
        }
        return f
...
var jdnb9Jx15vpWVTnv0cakVQ6X1Ccn5twi6U = function (n, t, e)
{
    var f = "DECODE";
    var t = t ? t : "";
    var e = e ? e : 0;
...
function jandan_load_img(b)
{
    ...
    var e = f.text();
    f.remove();
    var c = jdnb9Jx15vpWVTnv0cakVQ6X1Ccn5twi6U(e, "IkE3nzHrdX4qoau1Xq6xojPE7GHmdlOW");
    ...
    if (/\.gif$/.test(c))
    {
        ...
        {
            add_im
            g_loading_mask(this, load_sina_gif)
        }
    }
}
$(function ()
{
    ...
    k.done(function (p)
    {
        ...
        n.append('<li><a href=
            "' + $JANDAN.ADMIN_URL + '/wp-admin/admin.php?page=jdcomment">审帖(' + p.pending_comments + ")</a></li>");
