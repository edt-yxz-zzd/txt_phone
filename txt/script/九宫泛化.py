...
script.九宫泛化
py -m nn_ns.app.debug_cmd   script.九宫泛化 -x # -off_defs
py -m nn_ns.app.doctest_cmd script.九宫泛化:__doc__ -ht # -ff -df
#######
from seed.pkg_tools.ModuleReloader import mk_doctestXmodule_reloader_
doctestXmodule_reloader = mk_doctestXmodule_reloader_('', 'script.九宫泛化:__doc__', '-ht')
...
copy to:e ../lots/NOTE/玄学/河图洛书/特性纟标准泛九宫配置.txt
...
py_adhoc_call   script.九宫泛化   ,构造冫标准泛九宫扌 =3
[4, 9, 2]
[3, 5, 7]
[8, 1, 6]
